    ...
    <body>
        <div class="container text-center text-success mt-5">
            <ul class="list-group">
                ...
                <li class="list-group-item fs-5">Phone: <%= user.getEmail()%></li>
                <li class="list-group-item fs-5">City: <%= user.getPhone()%></li>
                <li class="list-group-item fs-5">Address: <%= user.getPassword()%></li>
            </ul>
        </div>
    </body>
</html>
