<%@page import="mypackage.AdminUser"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>

<% AdminUser user = (AdminUser) session.getAttribute("logUser");
    if (user == null) {
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown fs-5">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="./addproucts.jsp">Add New Product</a></li>
                                <li><a class="dropdown-item" href="./product.jsp">Product List</a></li>
                            </ul>
                        </li>
                         <li class="nav-item dropdown fs-5">
                            <a class="nav-link dropdown-toggle text-light" id="navbarDropdown" href="#" role="button"
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="./cutomerlist.jsp">View All</a></li>
                                <li>
                                    <hr class="dropdown-divider" />
                                </li>
                    ...
                    <form action="adminprofile.jsp" method="POST" class="d-flex">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" id="p2" href="buynow.jsp"
                                                            onclick="prodPreview('2.jpg', 'Power-Gel', '479', '● Chemical composition: Humates-25%min. (containing Humic Acid 15% on dry basis), Fulvic acid 2% min. Seaweed Extracts-5% min. (containing Alginic acid 0.1%) and performance Enhancing Adjuvants 68% max, Total-100% w/w. <br>● Dosage: Spray: 25g /pump( 15Litre ), Drip & Drenching:500g-750g /acre Method of application: Spray, Drip & Drenching.')">Buy Now
                                        </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" id="p7" href="buynow.jsp"
                                                            onclick="prodPreview('7.jpg', 'Gladiator Mist Blower Gun', '1299', '● Precautions: · Always tighten all the connections before and while spraying. · Please ensure to switch off the power button of the Gun after spraying is done. · Please avoid direct contact to the running fan. · Always wear a safety kit while spraying. · Always fully charge the battery spray pump before using Gladiator mist blower Gun. <br>● Battery backup: Gladiator mist blower gun can empty 5 tanks with a fully charged 12*12 battery & and 3 tanks with a fully charged 12*8 battery (Tank capacity 16 liters).')">Buy Now
                                        </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="buynow.jsp">Buy Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
